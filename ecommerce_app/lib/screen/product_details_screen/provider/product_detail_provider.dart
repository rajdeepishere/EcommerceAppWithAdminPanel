...
class ProductDetailProvider extends ChangeNotifier {
  ...
  void addToCart(Product product){
    ...
    flutterCart.addToCart(cartModel: CartModel(productId: '${product.sId}', productName: '${product.name}',productImages: ['${product.images!.isNotEmpty ? product.images![0].url : ''}'] , variants: [ProductVariant(price: price ?? 0, color: selectedVariant)], productDetails: '${product.description}'));
